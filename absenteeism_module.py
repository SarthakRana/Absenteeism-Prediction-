...
class absenteeism_model():
        ...
        def load_and_clean_data_single_input(self, df_row):
            ...
            reason_num = df['Reason for Absence'][0]
            reason_num = int(reason_num)
            if(reason_num >= 1 and reason_num <=14):
                df['reason_type_1'] = 1
                df['reason_type_2'] = 0
                df['reason_type_3'] = 0
                df['reason_type_4'] = 0
            elif (reason_num >= 15 and reason_num <= 17):
                df['reason_type_1'] = 0
                df['reason_type_2'] = 1
                df['reason_type_3'] = 0
                df['reason_type_4'] = 0
            elif (reason_num >= 18 and reason_num <= 21):
                df['reason_type_1'] = 0
                df['reason_type_2'] = 0
                df['reason_type_3'] = 1
                df['reason_type_4'] = 0
